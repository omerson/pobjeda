...
class Acl extends Component
{
	...
	private $_privateResources = array(
		'users' => array('index', 'search', 'edit', 'delete', 'changePassword'),
		'xml' => array('index', 'search', 'edit', 'create', 'delete'),
		'pretraga' => array('index')
	);
	...
	{
		return isset($this->_privateResources[$controllerName][$actionName]);
	}
	...
	public function getAcl()
	{
		...
		if (function_exists('apc_store')) {
			apc_store('Pobjeda-acl', $this->_acl);
		}
