...
use Pobjeda\Forms\ChangePasswordForm,
	Pobjeda\Forms\UsersForm,
	Pobjeda\Models\Users,
	Pobjeda\Models\PasswordChanges;

/**
 * Pobjeda\Controllers\UsersController
 *
...
class UsersController extends ControllerBase
{
	...
	public function searchAction()
	{
		...
		if ($this->request->isPost()) {
			$query = Criteria::fromInput($this->di, 'Pobjeda\Models\Users', $this->request->getPost());
