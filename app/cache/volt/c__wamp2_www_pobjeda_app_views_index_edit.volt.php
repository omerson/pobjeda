        ...
        <div class="tab-pane" id="B">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v16789524081iterated = false; ?><?php foreach ($user->successSearch as $search) { ?><?php $v16789524081iterated = true; ?>
                        <tr>
        ...
        <div class="tab-pane" id="C">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v16789524081iterated = false; ?><?php foreach ($user->successLogins as $login) { ?><?php $v16789524081iterated = true; ?>
                        <tr>
                            <td><?php echo $login->idLogins; ?></td>
        ...
        <div class="tab-pane" id="D">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v16789524081iterated = false; ?><?php foreach ($user->successLogouts as $logout) { ?><?php $v16789524081iterated = true; ?>
                        <tr>
        ...
        <div class="tab-pane" id="E">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v16789524081iterated = false; ?><?php foreach ($user->passwordChanges as $change) { ?><?php $v16789524081iterated = true; ?>
                        <tr>
        ...
        <div class="tab-pane" id="F">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v16789524081iterated = false; ?><?php foreach ($user->resetPasswords as $reset) { ?><?php $v16789524081iterated = true; ?>
                        <tr>
