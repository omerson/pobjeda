...
<table id="dvData" class="table table-bordered table-striped" align="center">
    ...
    <thead>
        <tr>
            ...
            <td><?php echo $this->tag->linkTo(array('items/mikro/' . $item->Mikro, $item->Mikro, 'class' => 'btn')); ?></td>            
        </tr>
         <tr>
            <th>Jedinicno Id</th>
...
<?php echo $this->tag->linkTo(array('items/pdf/' . $item->idJedinicno . '?itemtype=jedinicno', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
