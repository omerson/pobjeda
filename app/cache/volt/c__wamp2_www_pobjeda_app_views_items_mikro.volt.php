...
<table id="dvData" class="table table-bordered table-striped" align="center">
    ...
    <thead>
        <tr>
            ...
            <td><?php echo $this->tag->linkTo(array('items/paketi/' . $item->Paketi, $item->Paketi, 'class' => 'btn')); ?></td>            
        </tr>  
        <tr>
            <th>Mikro Id</th>
        ...
        <tr>
            ...
            <td>
                <?php foreach ($subItems as $p) { ?>   
                     <?php echo $this->tag->linkTo(array('items/jedinicno/' . $p->idJedinicno, $p->idJedinicno, 'class' => 'btn')); ?>
                <?php } ?>
            </td>     
        </tr>
...
<?php echo $this->tag->linkTo(array('items/pdf/' . $item->idMikro . '?itemtype=mikro', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
