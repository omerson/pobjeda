        ...
        <div class="tabbable">
            <div class="tab-content">
                <div class="tab-pane active" id="A">
                    ...
                    <?php echo Phalcon\Tag::linkTo(array('users/changePassword', 'Change Password')); ?>
                </div>
                ...
                <div class="tab-pane" id="B">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                            <?php $v23112644801iterated = false; ?><?php foreach ($user->successSearch as $search) { ?><?php $v23112644801iterated = true; ?>
                                <tr>
                ...
                <div class="tab-pane" id="C">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                            <?php $v23112644801iterated = false; ?><?php foreach ($user->successLogins as $slogins) { ?><?php $v23112644801iterated = true; ?>
                                <tr>
                ...
                <div class="tab-pane" id="D">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                            <?php $v23112644801iterated = false; ?><?php foreach ($user->failedLogins as $login) { ?><?php $v23112644801iterated = true; ?>
                                <tr>
                ...
                <div class="tab-pane" id="E">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                            <?php $v23112644801iterated = false; ?><?php foreach ($user->successLogouts as $logout) { ?><?php $v23112644801iterated = true; ?>
                                <tr>
                ...
                <div class="tab-pane" id="F">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                            <?php $v23112644801iterated = false; ?><?php foreach ($user->passwordChanges as $change) { ?><?php $v23112644801iterated = true; ?>
                                <tr>
                ...
                <div class="tab-pane" id="H">
                    <p>
                        <table class="table table-bordered table-striped" align="center">
                            ...
                            <tbody>
                                <?php $v23112644801iterated = false; ?><?php foreach ($user->resetPasswords as $reset) { ?><?php $v23112644801iterated = true; ?>
                                    <tr>
