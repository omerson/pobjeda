...
<table id="dvData" class="table table-bordered table-striped" align="center">
    ...
    <thead>
        <tr>
            ...
            <td><?php echo Phalcon\Tag::linkTo(array('items/mikro/' . $item->Mikro, $item->Mikro, 'class' => 'btn')); ?></td>            
        </tr>
         <tr>
            <th>Jedinicno Id</th>
            <td><?php echo $item->idJedinicno; ?></td>            
        </tr>
        <tr>
            <th>Item number</th>
...
<?php echo Phalcon\Tag::linkTo(array('items/pdf/' . $item->idJedinicno . '?itemtype=jedinicno', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
