...
<table id="dvData" class="table table-bordered table-striped" align="center">
    ...
    <thead>
        <tr>
            ...
            <td><?php echo Phalcon\Tag::linkTo(array('items/artupal/' . $item->Artupal, $item->Artupal, 'class' => 'btn')); ?></td>            
        </tr>   
        <tr>
            <th>Paketi Id</th>
        ...
        <tr>
            ...
            <td>
                <?php foreach ($subItems as $p) { ?>   
                     <?php echo Phalcon\Tag::linkTo(array('items/mikro/' . $p->idMikro, $p->idMikro, 'class' => 'btn')); ?>
                <?php } ?>
            </td>       
        </tr>
    </tbody>
...
<?php echo Phalcon\Tag::linkTo(array('items/pdf/' . $item->idPaketi . '?itemtype=paketi', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
