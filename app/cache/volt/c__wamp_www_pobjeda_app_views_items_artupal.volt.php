...
<table id="dvData" class="table table-bordered table-striped" align="center">
    <thead>
        <tr>
            ...
            <td><?php echo Phalcon\Tag::linkTo(array('items/palete/' . $item->Palete, $item->Palete, 'class' => 'btn')); ?></td>            
        </tr>
        <tr>
            <th>Artupal Id</th>
        ...
        <tr>
            ...
            <td>
                <?php foreach ($subItems as $p) { ?>   
                     <?php echo Phalcon\Tag::linkTo(array('items/paketi/' . $p->idPaketi, $p->idPaketi, 'class' => 'btn')); ?>
                <?php } ?>
            </td>      
        </tr>
...
<?php echo Phalcon\Tag::linkTo(array('items/pdf/' . $item->idArtupal . '?itemtype=artupal', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
