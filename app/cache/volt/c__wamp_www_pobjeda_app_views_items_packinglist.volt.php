...
<?php echo Phalcon\Tag::linkTo(array('items/pdf/' . $item->idPacking_List . '?itemtype=packingList', '<i class=\'icon-leaf icon-white\'></i>Get as PDF', 'class' => 'btn btn-danger', 'target' => '_blank')); ?>
